    ...
    const WIZARD_MARKUP = `
            ...
            <form id="modalTaskForm" onsubmit="handleTaskSubmit(event)" novalidate>
                ...
                <section class="wm-step" data-step="4" role="tabpanel" hidden>
                    ...
                    <div class="service-charge-box"><div class="charge-header"><i class="fas fa-receipt"></i><span>Charges</span></div><div class="charge-details"><div class="charge-row"><span>Task Budget:</span><span id="displayTaskBudget">₹100</span></div><div class="charge-row" id="serviceChargeRow" style="color:#10b981;"><span>+ Service Charge (<span id="serviceChargeLevel">Delivery</span>):</span><span id="serviceChargeAmount">₹15</span></div><div class="charge-row" id="serviceChargeTimeRow" style="font-size:12px;color:#666;"><span>Est. Time:</span><span id="serviceChargeTime">15-30 mins</span></div><div class="charge-row" style="color:#d97706;"><span>+ Platform Fee (5%):</span><span id="platformFeeAmount">₹5</span></div><div class="charge-row total"><span><strong>Total You Pay:</strong></span><span><strong id="totalPayable">₹110</strong></span></div></div><p class="charge-note"><i class="fas fa-info-circle"></i> 5% Platform Fee applies to all tasks. Service charge (₹10–₹40 by distance) applies <strong>only to Delivery &amp; Pick/Drop</strong> tasks. All other categories have no service charge.</p></div>
