    ...
    const WIZARD_MARKUP = `
            ...
            <form id="modalTaskForm" onsubmit="handleTaskSubmit(event)" novalidate>
                ...
                <section class="wm-step" data-step="4" role="tabpanel" hidden>
                    ...
                    <div class="service-charge-box"><div class="charge-header"><i class="fas fa-receipt"></i><span>Charges</span></div><div class="charge-details"><div class="charge-row"><span>Task Budget:</span><span id="displayTaskBudget">₹100</span></div><div class="charge-row" style="color:#10b981;"><span>+ Service Charge (<span id="serviceChargeLevel">Medium</span>):</span><span id="serviceChargeAmount">₹50</span></div><div class="charge-row" style="font-size:12px;color:#666;"><span>Est. Time:</span><span id="serviceChargeTime">1-3 hours</span></div><div class="charge-row" style="color:#d97706;"><span>+ Task Posting Fee (5%):</span><span id="platformFeeAmount">₹8</span></div><div class="charge-row total"><span><strong>Final Task Value:</strong></span><span><strong id="totalPayable">₹150</strong></span></div><div class="charge-row" style="color:#10b981;font-size:13px;margin-top:5px;"><span>Worker Earns (after 12% commission):</span><span><strong id="workerEarns">₹150</strong></span></div></div><p class="charge-note"><i class="fas fa-info-circle"></i> Pick &amp; Drop is free. Delivery: ₹10–₹40 (by distance) | Medium ₹40–50 | Skilled ₹60–70 | Expert ₹70–80 | Professional ₹90–100</p></div>
